...
const Home = () => {
  ...
  return (
    <div className="home_main_container">
      ...
      <div className="relative">
        <Image src={vectorline} alt="vectorgreen" className="absolute top-[6rem] left-[11.8rem]" />
        {
          data2.map((item, i) => {
            return(
              <>
              <div className="flex  gap-20  items-center px-60 pb-40 justify-between ">
      ...
      <div className="flex justify-center items-center gap-20 py-12 px-60">
        {
          data3.map((item, i) => { 
            return(
              <>
              <div className={`relative flex flex-1 flex-col gap-12 p-24 justify-center items-center ${ i%2 !==0 ? "bg-blue-color" : "bg-gray-300"} rounded-2xl`}>
                ...
                <h3 className={`${ i%2 !==0 ? "text-white" : "text-footer_text_grey_color"} text-xl leading-relaxed text-center w-[90%] `}>{item.desc}</h3>
